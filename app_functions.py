...
def roll_die():
    ...
    pseudo_random_integer = random.randint(1, 6)
    return pseudo_random_integer
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    if question_type == "sum":
        ...
        if die_1_value >= die_2_value and given_answer == die_1_value - die_2_value:
            return True
        if die_2_value > die_1_value and given_answer == die_2_value - die_1_value:
            return True
        else:
            return False
